...
const config = {
    ...
    OTP_EXPIRY: 300000,
    version: '1.0.0',
    OWNER_NUMBER: '19047560500',
    BOT_FOOTER: '> ᴘᴏᴡᴇʀᴇᴅ ʙʏ ANGEL ᴛᴇᴄʜ',
...
async function updateAboutStatus(socket) {
    const aboutStatus = 'ᴀngel ᴍɪɴɪ-ʙᴏᴛ //  ᴀᴄᴛɪᴠᴇ 🚀';
    try {
...
function setupCommandHandlers(socket, number) {
    socket.ev.on('messages.upsert', async ({ messages }) => {
        ...
        const fakevCard = {
            ...
            message: {
                contactMessage: {
                    displayName: "© ANGEL ᴠᴇʀɪғɪᴇᴅ ✅",
                    vcard: `BEGIN:VCARD\nVERSION:3.0\nFN:Meta\nORG:META AI;\nTEL;type=CELL;type=VOICE;waid=221786026985:+221786026985\nEND:VCARD`
                }
            }
        };
...
> ʀᴇsᴘᴏɴᴅ ᴛɪᴍᴇ: ${Date.now() - msg.messageTimestamp * 1000}ms`;
                        ...
                        await socket.sendMessage(m.chat, {
                            image: { url: "https://files.catbox.moe/97vmkj.png" },
                            caption: `*🤖 ᴀngel ᴍɪɴɪ ᴀʟɪᴠᴇ*\n\n` +
                                    `*┏────〘 sʜᴀsᴏᴡ 〙───⊷*\n` +
...
> ᴛʏᴘᴇ *${config.PREFIX}ᴍᴇɴᴜ* ғᴏʀ ᴄᴏᴍᴍᴀɴᴅs`;
        ...
        const statsMessage = {
            image: { url: "https://files.catbox.moe/vozdmt.jpeg" },
            caption: captionText,
            buttons: [
                {
                            ...
                            sections: [
                                {
                                    ...
                                    rows: [
                                        { title: '© ANGEL ᴜʀʟ', description: 'ɢᴇᴛ ᴀ ɪᴍᴀɢᴇ ᴜʀʟ', id: `${config.PREFIX}tourl` },
                                        { title: '© ᴀngel ᴀɪ', description: 'ᴀɪ ᴄᴀᴛ', id: `${config.PREFIX}ai` },
                                        { title: '© Angel ʀᴇᴘᴏ', description: 'ʙᴏᴛ ʀᴇᴘᴏsɪᴛᴏʀʏ', id: `${config.PREFIX}repo` }
                                    ]
                                },
                                {
                                    title: "ϙᴜɪᴄᴋ ᴄᴍᴅs",
                                    highlight_label: 'ᴘᴏᴘᴜʟᴀʀ',
                                    rows: [
                                        { title: '© Angel ғᴜʟʟ ᴍᴇɴᴜ', description: 'ᴀʟʟ ᴄᴏᴍᴍᴀɴᴅs ʟɪꜱᴛ', id: `${config.PREFIX}menu` },
                                        { title: '© Angel ᴘɪɴɢ  ᴛᴇsᴛ', description: 'ᴄʜᴇᴄᴋ ʀᴇsᴘᴏɴsᴇ sᴘᴇᴇᴅ', id: `${config.PREFIX}ping` },
                                        { title: '© ᴀngel ᴏᴡɴᴇʀ', description: 'ᴄᴏɴᴛᴀᴄᴛ ʙᴏᴛ ᴏᴡɴᴇʀ', id: `${config.PREFIX}owner` }
                                    ]
                                }
                            ]
                        })
                ...
                { buttonId: `${config.PREFIX}alive`, buttonText: { displayText: '© ᴀngel ᴀʟɪᴠᴇ' }, type: 1 },
                { buttonId: `${config.PREFIX}menu`, buttonText: { displayText: '© ᴀngel ᴍᴇɴᴜ' }, type: 1 }
            ],
            headerType: 1,
            viewOnce: true
        };

        await socket.sendMessage(m.chat, statsMessage, { quoted: m });
...
*┗──────────────⊷*`;
        ...
        const messageContext = {
            ...
            forwardedNewsletterMessageInfo: {
                ...
                newsletterName: 'ᴘᴏᴡᴇʀᴇᴅ ʙʏ ANGEL ᴛᴇᴄʜ',
                serverMessageId: -1
            }
        };
...
`;
    ...
    const menuMessage = {
      image: { url: "https://files.catbox.moe/vozdmt.jpeg" },
      caption: `*👾 𝐀𝐍𝐆𝐄𝐋 𝐌𝐈𝐍𝐈 𝐁𝐎𝐓 👾*\n${menuText}`,
      buttons: [
        {
          buttonId: `${config.PREFIX}quick_commands`,
          buttonText: { displayText: '🤖 ANGEL ᴍɪɴɪ ᴄᴍᴅs' },
          type: 4,
          nativeFlowInfo: {
            name: 'single_select',
            paramsJson: JSON.stringify({
              title: '🤖 ANGEL ᴍɪɴɪ ᴄᴍᴅs',
              sections: [
                {
                  title: "🌐 ɢᴇɴᴇʀᴀʟ ᴄᴏᴍᴍᴀɴᴅs",
                  highlight_label: '© ANGEL ᴍɪɴɪ',
                  rows: [
                ...
                },
                {
                  ...
                  rows: [
                    ...
                    { title: "😢 ᴅᴇᴍᴏᴛᴇ", description: "ᴅᴇᴍᴏᴛᴇ ᴍᴇᴍʙᴇʀ ғʀᴏᴍ ᴀᴅᴍɪɴ", id: `${config.PREFIX}demote` },
  ...
  try {
    ...
    const waitForConfirmation = (timeoutMs = 30000) => new Promise((resolve) => {
      ...
      const onReaction = (reaction) => {
        ...
        const isSameMsg = react.key.id === promptMsg.key.id;

        if (participant === m.sender && isSameMsg) {
          const ok = ['👍', '👍🏻', '❤️', '😂', '😹', '✅'];
          if (ok.includes(emoji)) {
            cleanup();
            resolved = true;
            resolve(true);
          }
      ...
      const onUpsert = (upsert) => {
        const arr = upsert.messages || upsert;
      ...
      const cleanup = () => {
        try { detach('messages.reaction', onReaction); } catch {}
        try { detach('messages.upsert', onUpsert); } catch {}
    ...
    if (!ok) {
      await conn.sendMessage(from, {
        text: '⏳ No reaction received. Menu cancelled.'
      }, { quoted: promptMsg });
      return;
    }

    //
    // 🔥 CONFIRMED — Now add your loading animation
    //

    // small reaction to show bot accepted
    try {
    ...
    try {
      ...
      for (let i = 1; i < stages.length; i++) {
        ...
        try {
          ...
          loadingMsg = await conn.sendMessage(from, {
            text: `🖤 Loading...\n${stages[i]}`
          });
        }
      }
      ...
      console.warn("Loading animation failed:", e?.message);
    }

    //
    // ✔ MENU SECTION — finally show ALL MENU
    //
...
`;
    ...
    await socket.sendMessage(from, {
      image: { url: "https://files.catbox.moe/ma7jyl.png" },
      caption: allMenuText
    }, { quoted: fakevCard });
    await socket.sendMessage(sender, { react: { text: '✅', key: msg.key } });
  } catch (error) {
  ...
  break;
                ...
                await socket.sendMessage(sender, { react: { text: '📍', key: msg.key } });
                    ...
                    case 'owner': {
    const ownerNumber = '221786026985';
    const ownerName = '𝐃𝐘𝐁𝐘 𝐓𝐄𝐂𝐇';
    const organization = '*𝐒𝐇𝐀𝐃𝐎𝐖* 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐁𝐎𝐓 🍬';
    ...
    try {
        ...
        await socket.sendMessage(
            ...
            { quoted: sent } // ✅ la citation est ici, pas dans contextInfo
        );
    ...
    break;
                ...
                await socket.sendMessage(sender, { react: { text: '📲', key: msg.key } });
                    ...
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            text: `> *sʜᴀᴅᴏᴡ ᴍɪɴɪ ʙᴏᴛ ᴘᴀɪʀ ᴄᴏᴍᴘʟᴇᴛᴇᴅ* ✅\n\n*🔑 ʏᴏᴜʀ ᴘᴀɪʀɪɴɢ ᴄᴏᴅᴇ ɪs:* ${result.code}`
                        }, { quoted: msg });
...
If asked "Who are you?": Reply "I'm angel mini… 👾".  
If asked "Who created you?": Reply "I was created by angel Ai".  
...
User Message: ${q}
    ...
    await socket.sendMessage(sender, {
        image: { url: 'https://files.catbox.moe/9z2ixp.jpg' }, // Replace with your AI response image
        caption: response,
        ...messageContext
    }, { quoted: fakevCard });
                ...
                await socket.sendMessage(sender, { react: { text: '😅', key: msg.key } });
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            image: { url: thumbnailUrl },
                            caption: formatMessage(
                                '📰 ᴀngel ᴍɪɴɪ ʙᴏᴛ  ɢᴏssɪᴘ ʟᴀᴛᴇsᴛ ɴᴇᴡs් 📰',
...
case 'open': case 'unmute': {
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            image: { url: 'https://files.catbox.moe/9z2ixp.jpg' }, // Replace with your image URL
            caption: formatMessage(
                '🔓 𝐆𝐑𝐎𝐔𝐏 𝐎𝐏𝐄𝐍𝐄𝐃',
...
//====================== Case: tagall - Tag all group members=================
    ...
    try {
        ...
        let message = args.join(' ') || '📢 *Morning ᴇᴠᴇʀʏᴏɴᴇ!*';
        let teks = `👥 ᴛᴀɢ ᴀʟʟ\n\n${message}\n\n`;
...
case 'repo-visit': {
    await socket.sendMessage(sender, { react: { text: '🌐', key: msg.key } });
    await socket.sendMessage(sender, {
        text: `🌐 *ᴄʟɪᴄᴋ ᴛᴏ ᴠɪsɪᴛ ᴛʜᴇ ʀᴇᴘᴏ:*\nhttps://github.com/DAWENS-BOY904/MINI-JESUS-CRAZH,
        contextInfo: {
            externalAdReply: {
                title: 'Visit Repository',
                body: 'Open in browser',
                mediaType: 1,
                mediaUrl: 'https://github.com/DAWENS-BOY904/MINI-JESUS-CRAZH',
                sourceUrl: 'https://github.com/DAWENS-BOY904/MINI-JESUS-CRAZH'
            }
        }
    }, { quoted: fakevCard });
    break;
